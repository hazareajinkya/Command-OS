...
export default function SquadChat({ onClose }: SquadChatProps) {
  ...
  // If onClose is provided, render as a modal (for backward compatibility)
  if (onClose) {
    return (
      <div
  ...
  // Embedded / inline mode — fits inside the right panel
  return (
